...
## Assignment
The LockedIn influencers are worried about account security. We've assured them that their passwords are secure enough, but they want data. Assuming a [brute-force](https://www.boot.dev/blog/security/how-do-brute-force-attackers-know-they-found-the-key/) guessing strategy on the part of an attacker, we want to know the maximum number of passwords they would have to try.
